...
$TestLabel = [CLRCLI.Widgets.Label]::new($Dialog)
$TestLabel.Text = "Default Text"
$TestLabel.Top = 5
$TestLabel.Left = 2
$TestLabel.AutoUpdateSchedule = 1000

$delegate = [System.Func[System.String]]{
...
$delegate.Invoke()
$TestLabel.UpdateAction = $delegate
$TestLabel.StartUpdate()
